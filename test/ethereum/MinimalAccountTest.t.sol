...
contract MinimalAccountTest is Test, ZkSyncChainChecker {
    ...
    function testOwnerCanExecuteCommands() public skipZkSync {
        ...
        minimalAccount.execute(dest, value, functionData); //this should have our minimal account mint some ERC20Mock to the minimal account
    ...
    function testEntryPointCanExecuteCommands() public skipZkSync {
        ...
        vm.deal(address(minimalAccount), 1e18); //to fund our contract
