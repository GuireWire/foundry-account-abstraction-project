...
contract ZkMinimalAccountTest is Test, ZkSyncChainChecker {
    ...
    function _createUnsignedTransaction(
        ...
        uint256 nonce = vm.getNonce(address(minimalAccount)); //this works somewhat
        bytes32[] memory factoryDeps = new bytes32[](0);
        return Transaction({
            txType: transactionType, // type 113 (0x71) - account abstraction transaction
            ...
            data: data,
            signature: hex"", //leaving as blank as this is the unsigned transaction
