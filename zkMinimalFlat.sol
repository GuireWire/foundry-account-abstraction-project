...
interface IAccount {
    ...
    //this is where bootloader calls transaction execution
    function executeTransaction(bytes32 _txHash, bytes32 _suggestedSignedHash, Transaction calldata _transaction)
        external
        payable;

    //this is where anyone calls the transaction execution (from outside)
...
contract ZkMinimalAccount is IAccount, Ownable {
    ...
    //who is the msg.sender when the function below is called? - the bootloader system contract
